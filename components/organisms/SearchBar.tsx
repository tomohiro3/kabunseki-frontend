...
export const SearchBar: React.FC<SearchBarProps> = (props) => {
  return (
    <SearchBarWrapper className={props.className}>
      <SearchBarInput id="searchbar-input" type="text" value={props.value} placeholder={props.placeholder} onChange={props.onChange} />
      <SearchBarButton aria-label="銘柄を検索する" id="searchbar-button" type="submit" onClick={props.onClick}>
